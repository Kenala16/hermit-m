...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '10_20_H_E_R_M_I_T_AQ_HEZK',
    ...
    BOT_NAME: process.env.BOT_NAME || 'ᴋᴇᴋᴇᴛsᴏ ʙᴏᴛ',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ᴋᴇᴋᴇᴛsᴏ ʙᴏᴛ;ᴋᴇɴᴅʀɪᴄᴋ;263714906216;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ᴋᴇᴋᴇᴛsᴏ ʙᴏᴛ;ᴋᴇɴᴅʀɪᴄᴋ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ᴋᴇᴋᴇᴛsᴏ ʙᴏᴛ;ᴋᴇɴᴅʀɪᴄᴋ' : process.env.STICKER_DATA,
